...
import (
	...
	essendixcissuerv1alpha1 "github.com/angeloxx/cert-manager-essendi-xc-issuer/api/v1alpha1"
	"github.com/angeloxx/cert-manager-essendi-xc-issuer/internal/controllers"
	"github.com/angeloxx/cert-manager-essendi-xc-issuer/internal/issuer/signer"
	"github.com/angeloxx/cert-manager-essendi-xc-issuer/internal/version"
...
func init() {
	...
	utilruntime.Must(essendixcissuerv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&essendixcAuthRealm, "auth-realm", "essendi_xc", "The realm to use when authenticating to the Essendi XC API.")
	...
	// flag.StringVar(&signer.ProtocolVersion, "protocol-version", "v1", "The protocol version")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "essendixcissuer.angeloxx.ch",
	...
	if err = (&controllers.IssuerReconciler{
		...
		HealthCheckerBuilder:     signer.EssendiHealthCheckerFromIssuerAndSecretData,
	...
	if err = (&controllers.CertificateRequestReconciler{
		...
		Scheme:                   mgr.GetScheme(),
		ClusterResourceNamespace: clusterResourceNamespace,
		AuthRealm:                essendixcAuthRealm,
		SignerBuilder:            signer.EssendiSignerFromIssuerAndSecretData,
