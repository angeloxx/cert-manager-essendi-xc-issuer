...
type IssuerSpec struct {
	...
	// Reference to customFields object in the Issuer resource.
	// +optional
	CustomFields []IssuerCustomField `json:"customFields,omitempty"`
	...
	IgnoreHostInApiResponse bool   `json:"ignoreHostInApiResponse"`
}
...
const (
	IssuerConditionStatusSubmitted  string = "Certificate request submitted"
	IssuerConditionStatusProcessing string = "Certificate request in progress"
	IssuerConditionStatusApproved   string = "Certificate request approved"
	IssuerConditionStatusSigned     string = "Certificate is signed"
)

const (
	TaskStatusProcessing = "PROCESSING"
	TaskStatusApproved   = "APPROVED"
	TaskStatusIssued     = "ISSUED"
	TaskStatusFailed     = "FAILED_IN_REVIEW"
